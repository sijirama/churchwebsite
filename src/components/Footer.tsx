        ...
        <main className="w-full bg-gray-200 py-7 md:py-18 z-10">
            <section className="max-w-[430px] md:max-w-[1300px] m-auto grid md:grid-cols-2  lg:grid-cols-4 gap-10">
                <div className="px-2 lg:px-6">
                    ...
                    <p className="text-base text-gray-600 font-light font-rubik">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla distinctio itaque nemo
                        aspernatur corrupti nesciunt.
                    </p>
                ...
                <div className="px-2 lg:px-6">
                    ...
                    <p className="text-base text-gray-600 font-light hover:text-primary cursor-pointer font-rubik py-1">
                        Home
                    </p>
                    <p className="text-base text-gray-600 font-light hover:text-primary cursor-pointer font-rubik py-1">
                        About
                ...
                <div className="px-2 lg:px-6">
                    ...
                    <p className="text-base text-gray-600 font-medium font-rubik py-1">
                    ...
                    <form className="flex flex-col gap-3 items-start py-2">
                        <input
                            ...
                            className="shadow-lg py-2 px-2 focus:outline-none border border-gray-400  lg:px-5 rounded-lg"
                        />
                        <button className="shadow-md w-40  p-2 rounded-lg bg-primary text-white font-rubik font-medium">
                            Subscribe now
                        </button>
                    </form>
                </div>
