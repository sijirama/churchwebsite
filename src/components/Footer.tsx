...
export default function Footer() {
    //const ICON_SIZE = 30
    return (
        <main className="w-full bg-gray-50 z-10 lg:h-96 md:h-96 h-[46rem] flex flex-col">
            <section className="grid grid-cols-3 md:grid-cols-4 gap-1 h-1/3 md:h-1/2 px-5 lg:px-0">
                ...
                <div className="col-span-2 font-manrope text-6xl md:text-6xl lg:text-9xl -tracking-widest font-extrabold text-black flex items-center justify-start">
                    Contact Us!
                </div>
